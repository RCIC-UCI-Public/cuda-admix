...
## [Unreleased](https://github.com/RCIC-UCI-Public/cuda-admix/compare/2.5...HEAD)

### Commits

- update copyright [`7cb0bbc`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/7cb0bbcb39aff05ffe38609bdf031400bb645f0f)
- rm fossils [`9a7d2d2`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/9a7d2d2f8afb8b3b8cc665097dbe1e3f13020d32)
- use actual rpm size [`0434663`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/0434663cb8d82acf2bd14d9d3fcb9f61d4070bae)
- update rpmdb [`31ef601`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/31ef60139ffe3061930a17c625c45a8b93b7d721)
- add notes  and templates on ffmpegv8 scaling [`d4f75bd`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/d4f75bd29ea7e23581591a564346e62251618531)
- add ffmpeg 8.0.1 and ffnvcodec 13.0.19.0 [`861e0b9`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/861e0b974e20b72c819910318a94a676182f1d61)
- add gdrcopy 2.5.1 for cuda 13. Modify yaml to change the name [`c490a4c`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/c490a4c24bf62bd3143f38fb538a4e741eaf6aba)
- update rpmdb for rocky 9.7 [`0cba44a`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/0cba44afeb517ac2ea400da3320ff269f50499dc)
- remove libpytohn dependencies. They are  not real but prevent [`8d4adba`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/8d4adba694f9a9a3d3fe4708ea7b798ee74e2156)
- remove cuda-palced ld.so.conf files. They make wrong dependencies for [`5477ea3`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/5477ea383a441946914ec6f773975ce35ba34f02)
- add --disable-vulkan to quiet down warnings and errrors [`a86501c`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/a86501ce67f4c1bf7c8ab85b89e3ab19f4f13cbf)
- Build cuda toolkit 13.0.1. Add to a filter to remove [`63b146a`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/63b146a806057e3723b805cdaec469b5e47826c2)
- remove extraneous empty line. [`fad192d`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/fad192d1cb567007d6672bebe39d04354f7e63b9)
- add building standalone driver version 580.82.07 that comes [`988b83d`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/988b83d85364bb5add711d27a40fccc0731ee392)
- add admix expected rpms sizes [`a2f1d10`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/a2f1d1069a5b02e8ea808427558a3ff9adb45b85)
- ignore build stage directories [`56f1ca1`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/56f1ca11b4c6a7d3065d7a4adbfc6a317b65f4a8)
- fix introduced typo [`5197164`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/5197164b226a0d82bd7128f54d23f6a18c0a61cc)
- The first statement of the description shdold [`d2eaf21`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/d2eaf212cedb4b98880cd9504209ecbffe27b69b)
- cudaTmp needs to be versioned for parallel build [`ed00d85`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/ed00d8504992a5e1a628e9c9b20035ba5ebeb1b3)
- Need to version the extractDir to support parallel builds [`160b84c`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/160b84c689812c8de713a17d8d37872347a315b7)
- add  ffmpeg versiob that was used in cuda 10. This is needed for ealier [`bd90a4b`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/bd90a4b918c916161f44df77f14769f163cd8026)
- Cuda11 installer honks because the system compiler is 'too new'.  add [`812ea27`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/812ea273cd32c4625ce74cf92053f70e465780fb)
- Update the version of the cuda standalone driver to lastest 12.2 to support [`88773ba`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/88773baef1548cf6d42a3e137504dd9978f5e154)
- Added NVIDIA run file for latest CUDA 12.2. This is to support newest [`cc9ed8c`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/cc9ed8ca033358521c1bd01cca8e71bd61178cc8)
- add admix name [`5678dbc`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/5678dbcfccf876643e3200c48022d2d1c3599d9e)
- fix typo [`d45a8fb`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/d45a8fba2786f0f6e17442d33d5611f7347d83e4)
- separate cuda10 into its own set. Simplify sets, no need to [`473e6a1`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/473e6a1e47a34dc2d0206a28d41bbacb40e9a093)

## [2.5](https://github.com/RCIC-UCI-Public/cuda-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog  before tagging [`57578ba`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/57578ba1c8fff359eb0e6f49aed949971722b2ff)
- extractDir2 is a  current dir [`55e4ccf`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/55e4ccfd8a9bd29a92ad947585906374d73441f0)
- only one version of libcudnn8 can be installed. Select the one from CUDA 12.2 [`c56f886`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/c56f88631d53776ce9ad6a50deac62a16aa35044)
- update CHANGELOG [`ec6597d`](https://github.com/RCIC-UCI-Public/cuda-admix/commit/ec6597df7b263b1d1ecccc25f8e63ea56e9ec8f2)
